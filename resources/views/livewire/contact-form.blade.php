    ...
    <form wire:submit="save">
        <div class="mt-4 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-4">
            ...
            <div class="sm:col-span-2">
                ...
                <div class="mt-1">
                    <input wire:model="email" type="email" name="email" id="email" class="block w-full rounded-t-md border-0 border-b border-slate-300 border-transparent shadow-sm focus:border-indigo-600 focus:ring-0 focus:border-b-2 sm:text-sm">
            ...
            <div class="sm:col-span-2">
                ...
                <div class="flex justify-between pt-8">
                    <div class="flex-shrink-0">
                        <button type="submit" class="inline-flex items-center rounded-md bg-slate-700 px-6 py-3 text-sm font-medium font-semibold text-white shadow-sm hover:bg-slate-900 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Send Message</button>
                    </div>
                </div>
            </div>
